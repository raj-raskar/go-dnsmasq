...
[release]: https://github.com/raj-raskar/go-dnsmasq/releases
...
Download the binary for your OS from the [releases page](https://github.com/raj-raskar/go-dnsmasq/releases/latest).    
